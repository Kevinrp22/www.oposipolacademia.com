...
<style>
  ...
  .footer__1__contacto--title {
    text-transform: uppercase;
    font-size: 1.5em;
  }
  .footer__1__contacto--text {
    color: white;
  }

  .footer__1__contacto--item {
    display: flex;
    margin-bottom: 10px;
  }
  .footer__1__contacto--item span {
    margin-right: 10px;
    color: #0884d6;
  }
  ...
  /* RECORDATORIO TERMINAR RESPONSIVE DEL FOOTER */
